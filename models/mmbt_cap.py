...
class MY_MultimodalBertClf(nn.Module):
    def __init__(self, args):
        super(MY_MultimodalBertClf, self).__init__()
        self.args = args
    ...
    def forward(self, txt, mask, segment, img, raw_text=None, cap=None):
        ...
        # encoding = self.tokenizer(cap, padding='longest', truncation=True, max_length=64, return_tensors="pt")
