...
class JsonlDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        open_image = None
        if self.args.model in ["img", "concatbow", "concatbert", "mmbt", "mmbt_cap","mmbt_vilt"]:
            if self.data[index]["img"]:
                ...
                open_image = Image.fromarray(128 * np.ones((256, 256, 3), dtype=np.uint8))
            image = self.transforms(open_image)
        ...
        return sentence, segment, image, label, self.data[index]["text"], open_image
